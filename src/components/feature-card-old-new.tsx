    ...
    >
      <div className="px-8 py-8 md:px-10 md:py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-14 lg:gap-16 items-stretch text-left">
          <div className={cn("flex min-h-0 flex-col", imageClassName)}>
            <div
              className={cn(
                "relative h-full min-h-[320px] w-full rounded-2xl transition-colors duration-200",
                previewState === "old"
                  ? "bg-zinc-300/60 dark:bg-zinc-800/60"
                  : "bg-primary/10"
              )}
              role="img"
          ...
          <div className={cn("flex flex-col gap-6 md:gap-7", textOrderClassName)}>
            {eyebrow ? (
            ...
            <div
              ...
              className={cn(
                "relative rounded-2xl bg-primary/5 p-5 transition-[opacity,box-shadow] duration-200 hover:shadow-[0_16px_40px_-12px_hsl(var(--foreground)/0.35)]",
                previewState === "new"
                  ? "opacity-45"
            ...
            <div
              ...
              onBlur={() => setHoveredChoice(null)}
              className={cn(
                "relative rounded-2xl bg-background/60 p-5 transition-[opacity,box-shadow] duration-200 hover:shadow-[0_16px_40px_-12px_hsl(var(--foreground)/0.35)]",
                previewState === "old"
                  ? "opacity-45"
                  : "opacity-100 shadow-[0_16px_40px_-12px_hsl(var(--foreground)/0.35)]"
              )}
