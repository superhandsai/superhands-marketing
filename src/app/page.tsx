              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button data-sh-diff="c3"
                    type="submit"
                    className="relative h-12 px-8 w-full sm:w-[160px] text-base bg-blue-600 text-white font-medium rounded-[8px] transition-all duration-300 hover:bg-blue-700 hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center cursor-pointer whitespace-nowrap overflow-hidden group/btn"
                    disabled={loading}
