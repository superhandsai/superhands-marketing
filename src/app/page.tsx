            ...
            <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button
                    type="submit"
                    className="h-12 px-8 w-full sm:w-[160px] text-base bg-primary text-white font-medium rounded-[8px] transition-all duration-300 hover:bg-purple-600 hover:shadow-[0_0_20px_rgba(147,51,234,0.5)] hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center cursor-pointer whitespace-nowrap"
                    disabled={loading}
                  >
                    {loading ? (
