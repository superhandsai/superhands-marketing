...
function GradientTextHero() {
  ...
  return (
    <h2 data-sh-diff="c1" data-sh-diff="c1"
      ref={textRef}
...
function AnimatedScreen() {
  ...
  return (
    <div data-sh-diff="c2" data-sh-diff="c2" ref={sectionRef} className="w-full mt-24">
      {/* Monitor frame */}
  ...
  return (
    <div className="min-h-svh w-full bg-dot-pattern bg-background overflow-hidden relative">
      ...
      <div className="mx-auto max-w-5xl px-4 pt-8 pb-24 sm:px-6 lg:px-8 relative z-10">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button data-sh-diff="c3" data-sh-diff="c3"
                    type="submit"
                    className="relative h-12 px-8 w-full sm:w-[160px] text-base bg-green-600 text-white font-medium rounded-[8px] transition-all duration-300 hover:bg-green-700 hover:shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center cursor-pointer whitespace-nowrap overflow-hidden group/btn"
                    disabled={loading}
        ...
        <AnimatedScreen data-sh-diff="c4" data-sh-diff="c4" />
