...
function GradientTextHero() {
  ...
  return (
    <h2 data-sh-diff="c1" data-sh-diff="c1" data-sh-diff="c1" data-sh-diff="c1" data-sh-diff="c1"
      ref={textRef}
...
function AnimatedScreen() {
  ...
  return (
    <div data-sh-diff="c2" data-sh-diff="c2" data-sh-diff="c2" data-sh-diff="c2" data-sh-diff="c2" ref={sectionRef} className="w-full mt-24">
      {/* Monitor frame */}
  ...
  return (
    <div className="min-h-svh w-full bg-dot-pattern bg-background overflow-hidden relative">
      ...
      <div className="mx-auto max-w-5xl px-4 pt-8 pb-24 sm:px-6 lg:px-8 relative z-10">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button data-sh-diff="c3" data-sh-diff="c3" data-sh-diff="c3" data-sh-diff="c3" data-sh-diff="c3"
                    type="submit"
        ...
        <AnimatedScreen data-sh-diff="c4" data-sh-diff="c4" data-sh-diff="c4" data-sh-diff="c4" data-sh-diff="c4" />

        {/* FAQ Section */}
        <div className="w-full mt-24 animate-fade-in-up animation-delay-500">
          <h3 className="text-3xl sm:text-4xl font-bold text-red-600 mb-8 text-center">
